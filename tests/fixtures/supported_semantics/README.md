...
It should grow whenever Modelwright adds support for a new formula function, operator, token form, or reference form. The purpose is to keep a durable synthetic convergence harness that can be rerun in any development environment without private workbooks.
